...
export const getTrendingCoins = createAsyncThunk("dashboard/getTrendingCoins", async () => {
...
export const getTop10Crypto = createAsyncThunk("dashboard/getTop10Crypto", async () => {
  // ALWAYS MATCH URL FOR PESO AND DOLLAR
  const responsePHP = await axios.get(
...
export const getTop10Exchanges = createAsyncThunk("dashboard/getTop10Exchanges", async () => {
  const response = await axios.get(`${COINGECKO_BASE_URL}/exchanges?per_page=10`);
